...
namespace TencentCloudDnsSDK.Utils.Date
{
    public class TimeUtil
    {
        ...
        public static long DateTimeToUnixTimeStamp(string time)
        {
            if(DateTime.TryParse(time,out DateTime result))
            {
                return DateTimeToUnixTimeStamp(result);
            }
            throw new Exception("Input string is not time.");
        }
